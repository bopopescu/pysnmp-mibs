...
dsMainEntries = MibTableColumn((1, 3, 6, 1, 2, 1, 66, 1, 1, 3), Gauge32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: dsMainEntries.setDescription(' Number of entries mained in the Directory Server.')
dsCopyEntries = MibTableColumn((1, 3, 6, 1, 2, 1, 66, 1, 1, 4), Gauge32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: dsCopyEntries.setDescription(' Number of entries for which systematic (subordinate)\n            copies are maintained in the Directory Server.')
...
dsSubordinateHits = MibTableColumn((1, 3, 6, 1, 2, 1, 66, 1, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: dsSubordinateHits.setDescription(' Number of operations that were serviced from\n            the locally held object replications ( copy-\n            entries).')
